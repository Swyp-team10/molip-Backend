...
public class VoteService {
    ...
    public VoteDTO createVote(String providerId, Long teamBoardId, Long teamBoardMenuId, String optionSelected) {
        ...
        vote.setTeamBoardMenu(teamBoardMenu); // 설정: 투표 대상 메뉴
    ...
    private VoteDTO convertToDTO(Vote vote) {
        ...
        dto.setTeamBoardMenuId(vote.getTeamBoardMenu().getTeamBoardMenuId()); // 설정: 투표 대상 메뉴 ID
